/*
 * BarabasiIrisGenerator.h
 *
 *  Created on: May 28, 2013
 *      Author: forigem
 */

#ifndef BarabasiIrisGenerator_H_
#define BarabasiIrisGenerator_H_
...
/**
 * @ingroup generators
 * Generates a scale-free graph using the Barabasi-Iris preferential attachment model.
 */
class BarabasiIrisGenerator: public NetworKit::StaticGraphGenerator {
private:
	Graph initGraph;
...
public:
	 ...
	 */
	BarabasiIrisGenerator(count k, count nMax, count n0 = 0, bool batagelj=true);

	BarabasiIrisGenerator(count k, count nMax, const Graph& initGraph, bool batagelj=true);

	Graph generate() override;
};

} /* namespace NetworKit */
#endif /* BarabasiIrisGenerator_H_ */
