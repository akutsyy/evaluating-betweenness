...
BarabasiIrisGenerator::BarabasiIrisGenerator() {
}


BarabasiIrisGenerator::BarabasiIrisGenerator(count k, count nMax, count n0, bool batagelj) : initGraph(0), k(k), nMax(nMax), batagelj(batagelj) {
	if (k > nMax)
...
BarabasiIrisGenerator::BarabasiIrisGenerator(count k, count nMax, const Graph& initGraph, bool batagelj) : initGraph(initGraph), k(k), nMax(nMax), n0(0), batagelj(batagelj) {
...
Graph BarabasiIrisGenerator::generate() {
	if (batagelj) {
...
Graph BarabasiIrisGenerator::generateOriginal() {
	Graph G(nMax);
	if (n0 != 0) {
...
Graph BarabasiIrisGenerator::generateBatagelj() {
	count n = nMax;
	Graph G(nMax);
